...
export default function BookAppointment() {
  return (
    <div className="bg-gradient-to-b from-gray-200 to-gray-500 py-16 flex items-center justify-center">
      <div className="bg-white/20 backdrop-blur-lg border border-white/30 p-8 rounded-2xl shadow-lg w-full max-w-lg">
        ...
        <form className="space-y-4">
          ...
          <input
            type="date"
            className="w-full p-3 rounded-lg bg-white/30 text-black outline-none"
          />
          <input
            type="time"
            className="w-full p-3 rounded-lg bg-white/30 text-black outline-none"
